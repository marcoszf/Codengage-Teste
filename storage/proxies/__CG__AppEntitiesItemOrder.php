 ...
 */
class ItemOrder extends \App\Entities\ItemOrder implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'priceUnity', 'itemOrder', 'quantity', 'total'];
        }
     ...
     * {@inheritDoc}
     */
    public function setItemOrder(\App\Entities\Product $itemOrder)
    {
